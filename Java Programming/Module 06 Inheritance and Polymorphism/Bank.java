...
public class Bank
{
    public static void main(String[] args)
    {
        ...
        System.out.println("Account Number(Inherited from Super Class 'Account'): " + savingAccount1.getAccountNumber());
        System.out.println("Account Balance(Inherited from Super Class 'Account'): " + savingAccount1.getBalance());
